...
mapping:
	make run -f $(cToSwiftFolder)Makefile grammar=$(grammar) outputPath="DPTypeChecker" moduleName="CGrammar" additionalEnumCases="-extra-case 'Type' 'tTypeUnknown' -extra-case 'CoreType' 'cTUnknown'"
